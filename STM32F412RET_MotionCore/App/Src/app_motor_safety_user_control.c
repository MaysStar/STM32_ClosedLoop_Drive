...
static const float MOTOR_EMERGENCY_MAX_CURRENT = 0.210f;
static const float MOTOR_EMERGENCY_MAX_TEMPERATURE = 40.0f;
...
{
	xTaskCreate(motor_safety_user_control_task, "motor_safety_user_control_task", 256, NULL, 5, &motor_safety_user_control_handle);
